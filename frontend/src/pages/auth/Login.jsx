  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <button
        ...
        className="group mb-8 -ml-1 p-2 w-fit rounded-full hover:bg-white/10 transition-colors duration-200 flex items-center gap-2"
        aria-label="Volver"
      >
      ...
      <form id="login-form" onSubmit={handleSubmit} className="flex flex-col gap-4">
        <FormInput
          ...
          icon={<IconEmail className="w-4.5 h-4.5" />}
          type="text"
          name="email"
          placeholder="ejemplo@oxyra.com o usuario"
