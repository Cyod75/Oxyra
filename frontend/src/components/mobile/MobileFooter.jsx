...
export default function MobileFooter() {
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-base-100 border-t border-current z-50">
      <nav className="flex justify-around items-center py-2 text-base-content">
        {/* Botón Home */}
        <button className="flex flex-col items-center justify-center p-2 active:scale-95 transition">
          {/* SVG inline, cambiar fill="#e3e3e3" por fill="currentColor" */}
          <svg
        ...
        <button className="flex flex-col items-center justify-center p-2 active:scale-95 transition">
          ...
          <span className="text-xs mt-1">Estadística</span>
        </button>
      </nav>
    </footer>
  );
